...
**
** Created: Sun Jul 8 21:40:15 2018
...
public:
    ...
    void setupUi(QWidget *VehicleMTHistoryFaultPage)
    {
        ...
        BTN9 = new QPushButton(VehicleMTHistoryFaultPage);
...
""));
        BTN5 = new QPushButton(VehicleMTHistoryFaultPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN8 = new QPushButton(VehicleMTHistoryFaultPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTNHome = new QPushButton(VehicleMTHistoryFaultPage);
        ...
        BTN2 = new QPushButton(VehicleMTHistoryFaultPage);
        ...
        BTN6 = new QPushButton(VehicleMTHistoryFaultPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN1 = new QPushButton(VehicleMTHistoryFaultPage);
        ...
        BTN3 = new QPushButton(VehicleMTHistoryFaultPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN7 = new QPushButton(VehicleMTHistoryFaultPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN4 = new QPushButton(VehicleMTHistoryFaultPage);
...
""));
    ...
    void retranslateUi(QWidget *VehicleMTHistoryFaultPage)
    {
        ...
        BTN9->setText(QApplication::translate("VehicleMTHistoryFaultPage", "\347\241\256\345\256\232", 0, QApplication::UnicodeUTF8));
        BTN5->setText(QString());
        BTN8->setText(QString());
        BTNHome->setText(QString());
        BTN2->setText(QString());
        BTN6->setText(QString());
        BTN1->setText(QApplication::translate("VehicleMTHistoryFaultPage", "\350\277\224\345\233\236", 0, QApplication::UnicodeUTF8));
