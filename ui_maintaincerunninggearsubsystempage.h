/********************************************************************************
** Form generated from reading UI file 'maintaincerunninggearsubsystempage.ui'
**
** Created: Thu Jul 19 20:39:13 2018
**      by: Qt User Interface Compiler version 4.6.3
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_MAINTAINCERUNNINGGEARSUBSYSTEMPAGE_H
#define UI_MAINTAINCERUNNINGGEARSUBSYSTEMPAGE_H
...
class Ui_MaintainceRunningGearSubsystemPage
{
public:
    QPushButton *BTN2;
    QPushButton *BTN5;
    ...
    void setupUi(QWidget *MaintainceRunningGearSubsystemPage)
    {
        if (MaintainceRunningGearSubsystemPage->objectName().isEmpty())
            MaintainceRunningGearSubsystemPage->setObjectName(QString::fromUtf8("MaintainceRunningGearSubsystemPage"));
        MaintainceRunningGearSubsystemPage->resize(1024, 706);
        MaintainceRunningGearSubsystemPage->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 50);"));
        BTN2 = new QPushButton(MaintainceRunningGearSubsystemPage);
        ...
        BTN5 = new QPushButton(MaintainceRunningGearSubsystemPage);
...
""));
        BTN7 = new QPushButton(MaintainceRunningGearSubsystemPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN3 = new QPushButton(MaintainceRunningGearSubsystemPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN1 = new QPushButton(MaintainceRunningGearSubsystemPage);
        ...
        BTN8 = new QPushButton(MaintainceRunningGearSubsystemPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN9 = new QPushButton(MaintainceRunningGearSubsystemPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN4 = new QPushButton(MaintainceRunningGearSubsystemPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN6 = new QPushButton(MaintainceRunningGearSubsystemPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTNHome = new QPushButton(MaintainceRunningGearSubsystemPage);
        ...
        retranslateUi(MaintainceRunningGearSubsystemPage);

        QMetaObject::connectSlotsByName(MaintainceRunningGearSubsystemPage);
    } // setupUi

    void retranslateUi(QWidget *MaintainceRunningGearSubsystemPage)
    {
        MaintainceRunningGearSubsystemPage->setWindowTitle(QApplication::translate("MaintainceRunningGearSubsystemPage", "Form", 0, QApplication::UnicodeUTF8));
        BTN2->setText(QString());
        BTN5->setText(QString());
        BTN7->setText(QString());
        BTN3->setText(QString());
        BTN1->setText(QApplication::translate("MaintainceRunningGearSubsystemPage", "\350\277\224\345\233\236", 0, QApplication::UnicodeUTF8));
        BTN8->setText(QString());
        BTN9->setText(QApplication::translate("MaintainceRunningGearSubsystemPage", "\347\241\256\345\256\232", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class MaintainceRunningGearSubsystemPage: public Ui_MaintainceRunningGearSubsystemPage {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MAINTAINCERUNNINGGEARSUBSYSTEMPAGE_H
