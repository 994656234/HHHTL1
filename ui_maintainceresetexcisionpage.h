/********************************************************************************
** Form generated from reading UI file 'maintainceresetexcisionpage.ui'
**
...
#ifndef UI_MAINTAINCERESETEXCISIONPAGE_H
#define UI_MAINTAINCERESETEXCISIONPAGE_H
...
class Ui_MaintainceResetExcisionPage
{
public:
    QPushButton *BTN9;
    QPushButton *BTN2;
    ...
    void setupUi(QWidget *MaintainceResetExcisionPage)
    {
        if (MaintainceResetExcisionPage->objectName().isEmpty())
            MaintainceResetExcisionPage->setObjectName(QString::fromUtf8("MaintainceResetExcisionPage"));
        MaintainceResetExcisionPage->resize(1024, 706);
        MaintainceResetExcisionPage->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 50);"));
        BTN9 = new QPushButton(MaintainceResetExcisionPage);
...
""));
        BTN2 = new QPushButton(MaintainceResetExcisionPage);
        ...
        BTN5 = new QPushButton(MaintainceResetExcisionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN1 = new QPushButton(MaintainceResetExcisionPage);
        ...
        BTN6 = new QPushButton(MaintainceResetExcisionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTNHome = new QPushButton(MaintainceResetExcisionPage);
        ...
        BTN8 = new QPushButton(MaintainceResetExcisionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN7 = new QPushButton(MaintainceResetExcisionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN4 = new QPushButton(MaintainceResetExcisionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN3 = new QPushButton(MaintainceResetExcisionPage);
...
""));
        ...
        retranslateUi(MaintainceResetExcisionPage);

        QMetaObject::connectSlotsByName(MaintainceResetExcisionPage);
    } // setupUi

    void retranslateUi(QWidget *MaintainceResetExcisionPage)
    {
        MaintainceResetExcisionPage->setWindowTitle(QApplication::translate("MaintainceResetExcisionPage", "Form", 0, QApplication::UnicodeUTF8));
        BTN9->setText(QString());
        BTN2->setText(QString());
        BTN5->setText(QString());
        BTN1->setText(QApplication::translate("MaintainceResetExcisionPage", "\350\277\224\345\233\236", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class MaintainceResetExcisionPage: public Ui_MaintainceResetExcisionPage {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MAINTAINCERESETEXCISIONPAGE_H
