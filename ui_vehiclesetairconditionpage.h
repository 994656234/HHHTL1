...
#ifndef UI_VEHICLESETAIRCONDITIONPAGE_H
#define UI_VEHICLESETAIRCONDITIONPAGE_H
...
class Ui_VehicleSetAirConditionPage
{
public:
    QPushButton *BTN7;
    QPushButton *BTN5;
    ...
    {
        if (VehicleSetAirConditionPage->objectName().isEmpty())
            VehicleSetAirConditionPage->setObjectName(QString::fromUtf8("VehicleSetAirConditionPage"));
        VehicleSetAirConditionPage->resize(1024, 706);
        VehicleSetAirConditionPage->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0,50);"));
        BTN7 = new QPushButton(VehicleSetAirConditionPage);
...
""));
        BTN5 = new QPushButton(VehicleSetAirConditionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTNHome = new QPushButton(VehicleSetAirConditionPage);
        ...
        BTN2 = new QPushButton(VehicleSetAirConditionPage);
        ...
        BTN8 = new QPushButton(VehicleSetAirConditionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN9 = new QPushButton(VehicleSetAirConditionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN6 = new QPushButton(VehicleSetAirConditionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN3 = new QPushButton(VehicleSetAirConditionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        BTN1 = new QPushButton(VehicleSetAirConditionPage);
        ...
        BTN4 = new QPushButton(VehicleSetAirConditionPage);
...
"	transparent;background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 rgba(170,170,170,255),stop:1 rgba(150,150,150,255));\n"
""));
        LBLMP2 = new QLabel(VehicleSetAirConditionPage);
...
"font:20px \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        LBLM2 = new QLabel(VehicleSetAirConditionPage);
...
"font:20px \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        LBLMP1 = new QLabel(VehicleSetAirConditionPage);
...
"font:20px \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        LBLTC2 = new QLabel(VehicleSetAirConditionPage);
...
"font:20px \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        LBLM1 = new QLabel(VehicleSetAirConditionPage);
...
"font:20px \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        LBLTC1 = new QLabel(VehicleSetAirConditionPage);
...
"font:20px \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        QMetaObject::connectSlotsByName(VehicleSetAirConditionPage);
    } // setupUi

    void retranslateUi(QWidget *VehicleSetAirConditionPage)
    {
        VehicleSetAirConditionPage->setWindowTitle(QApplication::translate("VehicleSetAirConditionPage", "Form", 0, QApplication::UnicodeUTF8));
        BTN7->setText(QString());
        BTN5->setText(QString());
        BTNHome->setText(QString());
        BTN2->setText(QString());
        BTN8->setText(QString());
        BTN9->setText(QApplication::translate("VehicleSetAirConditionPage", "\347\241\256\345\256\232", 0, QApplication::UnicodeUTF8));
        BTN6->setText(QString());
        BTN3->setText(QString());
        BTN1->setText(QApplication::translate("VehicleSetAirConditionPage", "\350\277\224\345\233\236", 0, QApplication::UnicodeUTF8));
        BTN4->setText(QString());
        LBLMP2->setText(QApplication::translate("VehicleSetAirConditionPage", "H05", 0, QApplication::UnicodeUTF8));
        LBLM2->setText(QApplication::translate("VehicleSetAirConditionPage", "H04", 0, QApplication::UnicodeUTF8));
        LBLMP1->setText(QApplication::translate("VehicleSetAirConditionPage", "H02", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class VehicleSetAirConditionPage: public Ui_VehicleSetAirConditionPage {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_VEHICLESETAIRCONDITIONPAGE_H
